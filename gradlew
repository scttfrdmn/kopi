...
#
#   (2) In order to be able to use common unix tools, scripts should be POSIX
#       compatible not use bash or other non-standard shell features.
#
##############################################################################
...
# This is reliable for both direct invocations and symlinks.
